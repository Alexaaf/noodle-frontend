...
export const QIS = ({userID}) => {
    ...
    const [getQuiz, setgetQuiz] = useState(() =>{
        fetch("http://localhost:8080/quiz/findQuizByCourse/IS")
            .then(res => res.json())
                ...
                <div className="account-content">
                    ...
                    {quizArray.map(questions=>(
                        ...
                        <form className = "quiz-form">
                            ...
                            <br />
                            <input className="imput-form" value={question1} placeholder="Question" onChange={(e) => {setQuestion1(e.target.value); setCourse("IS")}}/>
